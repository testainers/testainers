...
|-----------------|----------------------------------------------------|:---------:|:-------:|:------:| 
| postgresql      | https://hub.docker.com/_/postgres                  | 18-alpine | v0.3.0  |   ✅    |
| httpbucket      | https://hub.docker.com/r/testainers/httpbucket     |  latest   | v0.3.0  |   ✅    |
| redis           | https://hub.docker.com/_/redis                     | 8-alpine  | v0.3.0  |   ✅    |
| sshd            | https://hub.docker.com/r/testainers/sshd-container |  latest   | v0.3.0  |   ✅    |
| MongoDB         | https://hub.docker.com/_/mongo                     |    7.0    | v0.3.0  |   ✅    |
| httpbin         | https://hub.docker.com/r/kennethreitz/httpbin      |  latest   | v0.3.0  |   ✅    |
| http-https-echo | https://hub.docker.com/r/mendhak/http-https-echo   |  latest   | v0.3.0  |   ✅    |
